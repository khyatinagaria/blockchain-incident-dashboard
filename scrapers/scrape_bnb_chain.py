"""
scrape_bnb_chain_web3.py
Fetches ALL BNB Chain entries from web3isgoinggreat.com using Playwright.
...
def main():
    ...
    output_file = "data/bnb_chain.csv"
    fieldnames = [

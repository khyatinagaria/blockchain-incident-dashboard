"""
scrape_celo_web3.py
Fetches ALL Celo entries from web3isgoinggreat.com using Playwright.
...
def parse_entry(entry_div):
    ...
    # source_url slug — used for both article_url fallback and links merge
    slug = ""
    for a in entry_div.find_all("a", href=True):
        href = a.get("href", "")

"""
scrape_hyperliquid_web3.py
Fetches ALL Hyperliquid entries from web3isgoinggreat.com using Playwright.
...
URL = f"{BASE}/?blockchain=hyperliquid"
...
def main():
    ...
    output_file = "data/hyperliquid.csv"
    fieldnames = [
